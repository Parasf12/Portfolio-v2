          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://web.abhaypp.com" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a> </div>
            </header>
            <div className="body">
              <h3>A/B Tracking,Device Geo, Landing Page,Url converter | Affiliate Website </h3>
              <p> Developed a landing page, url converter web app using React, API Gateway, and DynamoDB, enabling users to do url short, Create landing page, A/B tracking, Biopages, Device Targetting & Geo, Pixels Url, and access details through an interactive UI. </p>
            </div>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://ai.abhaypp.com" target="_blank" rel="noreferrer">
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>
                Notes website for  students based on NCERT - Notes | Old Exam Papers | Syllabus Here You Can Find All Notes and Exam Papers of NCERT for 9-10 Classes.
              </p>
            </div>
            <footer>
              <ul className="tech-list">
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://gravity.abhaypp.com" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>Gravity Ball Sample Project</h3>
              <p>Developed a Timepass Gravity Ball Game.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>Nodejs</li>
          ...
          <div className="project">
            <header>
              ...
              <div className="project-links">
                ...
                <a href="https://mines.abhaypp.com" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
            <div className="body">
              <h3>MineSweeper Game Using React</h3>
              <p>Developed a game is about revealing all cell , without clicking on the mines location cells, Left click for revealing the cell, Right Click to flag the cell(that don't want to reveal, you are guessing, it might have mines), You will win if non-mines reveal become zero.</p>
            </div>
            <footer>
              <ul className="tech-list">
                <li>React</li>
        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            <header>
              <svg width="50" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 24 24" fill="none" stroke="#23ce6b " stroke-width="1" stroke-linecap="round" stroke-linejoin="round" ><title>Folder</title><path d="M22 19a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5l2 3h9a2 2 0 0 1 2 2z"></path></svg>
              <div className="project-links">
                <a href="https://notenow.abhaypp.com" target="_blank" rel="noreferrer">
                  <img src={externalLink} alt="Visit site" />
                </a>
              </div>
            </header>
